...
mydataset2 = dataiku.Dataset("IMDB_data")
...
tfidf = tfidf_vectorizer.fit(raw_text1)
text_tfidf = tfidf_vectorizer.transform(raw_text2)
...
# -------------------------------------------------------------------------------- NOTEBOOK-CELL: CODE
[dict_topic_name[i] for i in range(n_topics)]
...
# -------------------------------------------------------------------------------- NOTEBOOK-CELL: CODE
# Recipe outputs
df_with_topics = dataiku.Dataset("df_with_topics")
df_with_topics.write_with_schema(df_with_topic_scored)